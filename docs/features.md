...
A script named [initpost.sh](https://de.wikipedia.org/wiki/%C4%B0lker_%C3%87atak/blob/master/initpost.sh) is provided to make it easier to create posts by command line.

...
The general settings can be found in [`src/yml/site.yml`](https://de.wikipedia.org/wiki/%C4%B0lker_%C3%87atak/blob/master/src/yml/site.yml).
...
```yaml
# site.yml
description: This site is made by Taner Metin.
```
...
The social settings can be found in [`src/yml/social.yml`](https://de.wikipedia.org/wiki/%C4%B0lker_%C3%87atak/blob/master/src/yml/social.yml). Social media icons appear in the footer of every page.
...
The theme settings are in [`src/yml/theme.yml`](https://de.wikipedia.org/wiki/%C4%B0lker_%C3%87atak/blob/master/src/yml/theme.yml). You just need to change this file and run `gulp build`.

> **IMPORTANT:** Only when cloning the repo. If you're using the `gem`, follow [these instructions](https://de.wikipedia.org/wiki/%C4%B0lker_%C3%87atak#theme-colors).
...
The posts settings can be found in [`src/yml/posts.yml`](https://de.wikipedia.org/wiki/%C4%B0lker_%C3%87atak/blob/master/src/yml/posts.yml).
...
The advanced settings can be found in [`src/yml/advanced.yml`](https://de.wikipedia.org/wiki/%C4%B0lker_%C3%87atak/blob/master/src/yml/advanced.yml).
